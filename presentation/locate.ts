        ...
        const pagesLocations = pages
          .map(({slug, title}) => {
            ...
            for (const lang of languages) {
              ...
              // Ensure title is an array before calling find
              const pageTitle = Array.isArray(title)
                ? title.find((t) => t._key === lang.id)?.value
                : null
              ...
              locations.push({
                ...
                title: pageTitle ? `${pageTitle} (${lang.title})` : `Page (${lang.title})`,
              })
            }
            ...
            for (const lang of languages) {
              ...
              locations.push({
                href: isDefaultLanguage
                  ...
                  : sanityPreviewPath(`${lang.id}/products/${store?.slug?.current}`),
                title: `${store?.title} (${lang.title})` || `Product (${lang.title})`,
              })
            }
            ...
            for (const lang of languages) {
              ...
              locations.push({
                href: isDefaultLanguage
                  ...
                  : sanityPreviewPath(`${lang.id}/collections/${store?.slug?.current}`),
                title: store?.title
